      ...
      OverlayMenuItem(
        ...
        child: Opacity(
          ...
          child: _sqlContextMenuLeadingRow(
            ...
            shortcutLabel: shortcutSvc.getShortcutModel(KeyboardShortcut.sqlEditorCopy).toDisplayString(),
          ),
        ),
      ),
      OverlayMenuItem(
        ...
        child: _sqlContextMenuLeadingRow(
          ...
          shortcutLabel: shortcutSvc.getShortcutModel(KeyboardShortcut.sqlEditorPaste).toDisplayString(),
        ),
      ),
    ];
  }
        ...
        final tabs = <OverlayMenuItem>[
          ...
          OverlayMenuItem(
            ...
            child: _sqlContextMenuLeadingRow(
              ...
              shortcutLabel: shortcutService.getShortcutModel(KeyboardShortcut.sqlEditorSelectAll).toDisplayString(),
            ),
          ),
          OverlayMenuItem(
            height: 40,
            ...
            child: Opacity(
              ...
              child: _sqlContextMenuLeadingRow(
                ...
                shortcutLabel: shortcutService.getShortcutModel(KeyboardShortcut.sqlEditorUndo).toDisplayString(),
              ),
            ),
          ),
          OverlayMenuItem(
            ...
            child: Opacity(
              ...
              child: _sqlContextMenuLeadingRow(
                ...
                shortcutLabel: shortcutService.getShortcutModel(KeyboardShortcut.sqlEditorRedo).toDisplayString(),
              ),
            ),
          ),
        ];
