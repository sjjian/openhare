...
- **Multi-Database Support**: Connect to MySQL, PostgreSQL, SQL Server, SQLite, DuckDB, Oracle, IBM Db2, MongoDB, Redis, and more.
...
| <img src="./client/assets/icons/db2_icon.png" width="28" alt="IBM Db2"> | IBM Db2 | [go-db2/go-db2](https://github.com/go-db2/go-db2) |
